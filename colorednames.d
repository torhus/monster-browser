...
static this() {
	...
	// red
	q3Colors[1] = new TextStyle(null, new Color(display, 220,   0,   0), null);
	// green
	q3Colors[2] = new TextStyle(null, new Color(display,   0, 150,   0), null);
	// yellow
	q3Colors[3] = new TextStyle(null, new Color(display, 198, 198,   0), null);
	// blue
	q3Colors[4] = new TextStyle(null, new Color(display,   0,   0, 204), null);
	// cyan
	q3Colors[5] = new TextStyle(null, new Color(display,   0, 204, 204), null);
	// magenta
